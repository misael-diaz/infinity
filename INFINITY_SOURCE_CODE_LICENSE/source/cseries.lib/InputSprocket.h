...
enum
{
	...
	kISpNeedFlag_Button_AlreadyAxis		= 0x10000000,   // there is an axis version of this button need
	kISpNeedFlag_Button_ClickToggles	= 0x20000000,
	kISpNeedFlag_Button_ActiveWhenDown	= 0x40000000,
	kISpNeedFlag_Button_AlreadyDelta	= 0x80000000,   // there is a delta version of this button need
	...
	// these are flags specific to kISpElementKind_Movement
};
...
OSStatus ISpTimeToMicroseconds(const AbsoluteTime *inTime, UnsignedWide *outMicroseconds);
