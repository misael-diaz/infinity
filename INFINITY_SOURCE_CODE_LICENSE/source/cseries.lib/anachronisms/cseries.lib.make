...
### Portable
{Obj}proximity_strcmp.c.o Ä proximity_strcmp.h cseries.h cseries.lib.make
{Obj}rle.c.o Ä rle.h cseries.h cseries.lib.make

### Macintosh
{Obj}macintosh_utilities.c.o Ä macintosh_cseries.h cseries.lib.make
{Obj}my32bqd.c.o Ä my32bqd.h macintosh_cseries.h cseries.lib.make
{Obj}devices.c.o Ä macintosh_cseries.h cseries.lib.make
{Obj}dialogs.c.o Ä macintosh_cseries.h cseries.lib.make
{Obj}preferences.c.o Ä preferences.h macintosh_cseries.h cseries.lib.make
{Obj}temporary_files.c.o Ä temporary_files.h macintosh_cseries.h cseries.lib.make

cseries.lib ÄÄ {OBJECTS}
	Lib -o cseries.lib {OBJECTS}
	Move -y cseries.lib {CSeriesLibraries}

cseries.lib ÄÄ {CSeriesInterfaces}cseries.h {CSeriesInterfaces}my32bqd.h {CSeriesInterfaces}rle.h ¶
...
{CSeriesInterfaces}macintosh_interfaces.c Ä macintosh_interfaces.c
