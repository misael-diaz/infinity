...
macintosh_cseries.h Ä cseries.h

### Portable
{Obj}proximity_strcmp.xcoff Ä proximity_strcmp.h cseries.h cseries.xcoff.make
{Obj}rle.xcoff Ä rle.h cseries.h cseries.xcoff.make

### Macintosh
{Obj}macintosh_utilities.xcoff Ä macintosh_cseries.h cseries.xcoff.make
{Obj}my32bqd.xcoff Ä my32bqd.h macintosh_cseries.h cseries.xcoff.make
{Obj}devices.xcoff Ä macintosh_cseries.h cseries.xcoff.make
{Obj}dialogs.xcoff Ä macintosh_cseries.h cseries.xcoff.make
{Obj}preferences.xcoff Ä preferences.h macintosh_cseries.h cseries.xcoff.make
{Obj}temporary_files.xcoff Ä temporary_files.h macintosh_cseries.h cseries.xcoff.make

cseries.xcoff ÄÄ {OBJECTS}
	PPCLink -o cseries.xcoff -xm library {OBJECTS}
	Move -y cseries.xcoff {CSeriesLibraries}

cseries.xcoff ÄÄ {CSeriesInterfaces}cseries.h {CSeriesInterfaces}my32bqd.h {CSeriesInterfaces}rle.h ¶
...
{CSeriesInterfaces}cseries.h Ä cseries.h
	Duplicate -y cseries.h {CSeriesInterfaces}
{CSeriesInterfaces}cseries.a Ä cseries.a
	Duplicate -y cseries.a {CSeriesInterfaces}
{CSeriesInterfaces}my32bqd.h Ä my32bqd.h
	Duplicate -y my32bqd.h {CSeriesInterfaces}
{CSeriesInterfaces}rle.h Ä rle.h
	Duplicate -y rle.h {CSeriesInterfaces}
{CSeriesInterfaces}preferences.h Ä preferences.h
	Duplicate -y preferences.h {CSeriesInterfaces}
{CSeriesInterfaces}macintosh_cseries.h Ä macintosh_cseries.h
	Duplicate -y macintosh_cseries.h {CSeriesInterfaces}
{CSeriesInterfaces}proximity_strcmp.h Ä proximity_strcmp.h
	Duplicate -y proximity_strcmp.h {CSeriesInterfaces}
{CSeriesInterfaces}temporary_files.h Ä temporary_files.h
	Duplicate -y temporary_files.h {CSeriesInterfaces}
{CSeriesInterfaces}macintosh_interfaces.h Ä macintosh_interfaces.c
