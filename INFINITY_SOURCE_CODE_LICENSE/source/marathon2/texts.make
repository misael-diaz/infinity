...
# This expects the level files to be named LnnÅ where nn is the level number, padded with a 
#   preceeding zero if it's a single digit.

#final
Texts ÄÄ {TextFiles}
	Directory texts
	Files LÅ | StreamEdit -d -e '/[Ll]([0-9]+)¨1.(Å)¨2/ print "Read ÁtermÁ (1"¨1 ", ª" ¨2 "ª) ªL" ¨1 "." ¨2 "ª;"' | Translate "¶'" | Translate "Áª" "¶'¶"" | Rez -o texts.resource
	SetFile texts.resource -c 'RSED' -t 'RSRC'
	Directory ::
	Echo Done.

#demo
Texts.demo ÄÄ {TextFiles}
...
#	Directory texts
#	Echo Encrypting...
#	for filename in `Files LÅ`
#		Catenate "{filename}" | Translate "A-MN-Z a-mn-z#" "N-ZA-Mn-z# a-m" > "E""{filename}"
#	end
#	Echo Rezzing...
#	Files ELÅ | StreamEdit -d -e '/E[Ll]([0-9]+)¨1.(Å)¨2/ print "Read ÁlevlÁ (10"¨1 ", ª" ¨2 "ª) ªEL" ¨1 "." ¨2 "ª;"' | Translate "¶'" | Translate "Áª" "¶'¶"" | Rez -o texts.resource
#	SetFile texts.resource -c 'RSED' -t 'RSRC'
#	Delete ELÅ
#	Directory ::
#	Echo Done.
